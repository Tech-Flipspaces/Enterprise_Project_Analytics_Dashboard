...
METRICS_CONFIG = {
    ...
    "Design": {
        "Pre": [
            ...
            {"label": "Client Visits", "field": "client_visit_des", "def": 1.0, "roles": ["ID", "DM", "DH"]},
        ],
        "Post": [
            {"label": "Furniture Layouts", "field": "furniture_layouts", "def": 1.0, "roles": ["ID", "DM", "DH"]},
            {"label": "Approved Furniture Layouts", "field": "approved_layouts", "def": 1.0, "roles": ["ID", "DM", "DH"]},
            {"label": "Other Layouts", "field": "other_layouts", "def": 1.0, "roles": ["ID", "DM", "DH"]},
            {"label": "Key Plans to Spaces", "field": "key_plans_ratio", "def": 0.33, "roles": ["ID"]},
            {"label": "No Key Plans Spaces", "field": "no_plans_for_key_spaces", "def": 1, "roles": ["ID"]},
            {"label": "Pins Mapped", "field": "mapped_spaces", "def": 3.0, "roles": ["ID"]},
            {"label": "Renders", "field": "renders", "def": 5.0, "roles": ["3D", "DM", "DH"]},
            ...
            {"label": "Auto GFC created", "field": "gfc_download", "def": 1.0, "roles": ["ID", "DM", "DH"]},
            {"label": "Client Visits", "field": "client_visit_des", "def": 1.0, "roles": ["DM", "DH"]},
        ]
    },
    "Operations": [
        {"label": "Site Images", "field": "site_images", "def": 30.0, "roles": ["SS", "OM", "PM", "Head"]},
        {"label": "Invoices / Receipts", "field": "invoices", "def": 1.0, "roles": ["OM", "PM", "Head"]},
        {"label": "MEP Drawings", "field": "mep_drawings", "def": 3.0, "roles": ["PM", "Head"]},
        {"label": "Handover Documents", "field": "handover_docs", "def": 3.0, "roles": ["PM", "Head"]},
        {"label": "WPR (Half Week)", "field": "wpr_half_week", "def": 0.5, "roles": ["PM", "Head"]},
        {"label": "WPRs Downloaded", "field": "wpr_download", "def": 3.0, "roles": ["PM", "Head"]},
        {"label": "WPRs Shared", "field": "wpr_shared", "def": 3.0, "roles": ["PM", "Head"]},
        {"label": "Unique Weekly Tasks", "field": "weekly_tasks", "def": 10.0, "roles": ["PM", "Head"]},
        {"label": "Unique Daily Tasks", "field": "daily_tasks", "def": 30.0, "roles": ["SS", "PM", "Head"]},
        {"label": "Manpower Ratio (Act/Plan)", "field": "manpower_ratio", "def": 0.66, "roles": ["SS", "OM", "PM", "Head"]},
        {"label": "DPR Added (% days)", "field": "dpr_ratio", "def": 0.5, "roles": ["SS", "PM", "Head"]},
        {"label": "Manpower Added (% days)", "field": "manpower_day_ratio", "def": 0.5, "roles": ["SS", "PM", "Head"]},
        {"label": "GRNs/SRNs Created", "field": "grn_created", "def": 3.0, "roles": ["SS", "OM", "PM", "Head"]},
        {"label": "GRNs/SRNs Approved", "field": "grn_approved", "def": 3.0, "roles": ["PM", "Head"]},
    ]
}
